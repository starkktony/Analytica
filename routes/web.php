...
| Role Access Matrix
|--------------------------------------------------------------------------
| Page / Section          | Admin | Executive | Director | Chief | Emp-T | Emp-NT |
|-------------------------|-------|-----------|----------|-------|-------|--------|
| Dashboard               |  ✓    |     ✓     |    ✓     |   ✓   |   ✓   |   ✓    |
| Student / Graduates     |  ✓    |     ✓     |    ✓     |   ✓   |   ✗   |   ✗    |
| Normative Funding       |  ✓    |     ✓     |    ✓     |   ✓   |   ✗   |   ✗    |
...
Route::middleware('auth')->group(function () {
    ...
    // ====================================================
    // STUDENT + GRADUATES + NORMATIVE FUNDING
    // Admin, Executive, Director, Chief only
    // ====================================================
    Route::middleware('role:Admin,Executive,Director,Chief,Employee-Teaching')->group(function () {
    ...
    // ====================================================
    // FACULTY
    // Admin, Executive, Director, Chief, Employee-Teaching
    // Employee-Non-Teaching is excluded
    // ====================================================
    Route::middleware('role:Admin,Executive,Director,Chief,Employee-Teaching,Employee-Non-Teaching')->group(function () {
    ...
    // Admin, Executive, Director, Chief only
    // ====================================================
    Route::middleware('role:Admin,Executive,Director,Chief')->prefix('radiis')->group(function () {
    ...
    // Director, Chief, and all Employees are excluded
    // ====================================================
    Route::middleware('role:Admin,Executive')->prefix('eis')->group(function () {
    ...
    // Admin only
    // ====================================================
    Route::middleware('role:Admin')->prefix('user/management')->group(function () {
