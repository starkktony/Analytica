@php
    ...
    $canViewRadiis      = in_array($role, ['Admin', 'Executive', 'Director', 'Chief']);
    $canViewEIS         = in_array($role, ['Admin', 'Executive']);
    $canViewUserMgmt    = $role === 'Admin';
@endphp
    ...
    <div class="sidebar-scrollable">
        ...
        <div class="sidebar-item">
            <div class="sidebar-parent {{ request()->is('student*') || request()->is('enrollment') || request()->is('graduation') || request()->is('scholarship') || request()->routeIs('graduates.index') ? 'active' : '' }}"
                ...
                <span class="sidebar-chevron" data-target="studentMenu" style="cursor:pointer;padding:0 16px 0 8px;">
            ...
            <div class="sidebar-submenu {{ request()->is('student*') || request()->is('enrollment') || request()->is('graduation') || request()->is('scholarship') || request()->routeIs('graduates.index') ? 'open' : '' }}"
                ...
                <a href="{{ route('graduates.index') }}" class="submenu-link {{ request()->routeIs('graduates.index') ? 'active' : '' }}">
        ...
        <div class="sidebar-item">
            <div class="sidebar-parent {{ request()->routeIs('stzfaculty.*') || request()->routeIs('suc-faculty.*') ? 'active' : '' }}"
                ...
                <span class="sidebar-chevron" data-target="facultyMenu" style="cursor:pointer;padding:0 16px 0 8px;">
                    <i class="bi bi-chevron-down"></i>
                </span>
            </div>
            <div class="sidebar-submenu {{ request()->routeIs('stzfaculty.*') || request()->routeIs('suc-faculty.*') ? 'open' : '' }}"
                ...
                <a href="{{ route('stzfaculty.teaching-load') }}" class="submenu-link {{ request()->routeIs('stzfaculty.teaching-load') ? 'active' : '' }}">
                    <i class="bi bi-book"></i><span class="menu-label">Teaching Load</span>
                </a>
                <a href="{{ route('stzfaculty.research-performance') }}" class="submenu-link {{ request()->routeIs('stzfaculty.research-performance') ? 'active' : '' }}">
                    <i class="bi bi-clipboard-data"></i><span class="menu-label">Research</span>
                </a>
                <a href="{{ route('stzfaculty.approval') }}" class="submenu-link {{ request()->routeIs('stzfaculty.approval') ? 'active' : '' }}">
                    <i class="bi bi-check2-circle"></i><span class="menu-label">Faculty Approval</span>
                </a>
                <a href="{{ route('suc-faculty.index') }}" class="submenu-link {{ request()->routeIs('suc-faculty.index') ? 'active' : '' }}">
        ...
        <div class="sidebar-item">
            <div class="sidebar-parent {{ request()->routeIs('normative-funding.*') ? 'active' : '' }}"
                ...
                <span class="sidebar-chevron" data-target="financialMenu" style="cursor:pointer;padding:0 16px 0 8px;">
                    <i class="bi bi-chevron-down"></i>
                </span>
            </div>
            <div class="sidebar-submenu {{ request()->routeIs('normative-funding.*') ? 'open' : '' }}"
                 id="financialMenu">
                <a href="{{ route('normative-funding.index') }}" class="submenu-link {{ request()->routeIs('normative-funding.index') ? 'active' : '' }}">
        ...
        <div class="sidebar-item">
            <div class="sidebar-parent {{ request()->routeIs('radiis.*') ? 'active' : '' }}"
                ...
                <span class="sidebar-chevron" data-target="radiisMenu" style="cursor:pointer;padding:0 16px 0 8px;">
                    <i class="bi bi-chevron-down"></i>
                </span>
            </div>
            <div class="sidebar-submenu {{ request()->routeIs('radiis.*') ? 'open' : '' }}"
                ...
                <a href="{{ route('radiis.projects') }}" class="submenu-link {{ request()->routeIs('radiis.projects') ? 'active' : '' }}">
                    <i class="bi bi-kanban"></i><span class="menu-label">Projects</span>
                </a>
                <a href="{{ route('radiis.studies') }}" class="submenu-link {{ request()->routeIs('radiis.studies') ? 'active' : '' }}">
                    <i class="bi bi-journal-bookmark"></i><span class="menu-label">Studies</span>
                </a>
                <a href="{{ route('radiis.publications') }}" class="submenu-link {{ request()->routeIs('radiis.publications') ? 'active' : '' }}">
                    <i class="bi bi-file-earmark-text"></i><span class="menu-label">Publications</span>
                </a>
                <a href="{{ route('radiis.presentations') }}" class="submenu-link {{ request()->routeIs('radiis.presentations') ? 'active' : '' }}">
                    <i class="bi bi-easel"></i><span class="menu-label">Presentations</span>
                </a>
                <a href="{{ route('radiis.iprights') }}" class="submenu-link {{ request()->routeIs('radiis.iprights') ? 'active' : '' }}">
                    <i class="bi bi-shield-check"></i><span class="menu-label">IP Rights</span>
                </a>
                <a href="{{ route('radiis.awards') }}" class="submenu-link {{ request()->routeIs('radiis.awards') ? 'active' : '' }}">
                    <i class="bi bi-trophy"></i><span class="menu-label">Awards</span>
                </a>
                <a href="{{ route('radiis.linkages') }}" class="submenu-link {{ request()->routeIs('radiis.linkages') ? 'active' : '' }}">
                    <i class="bi bi-link-45deg"></i><span class="menu-label">Linkages</span>
                </a>
                <a href="{{ route('radiis.researchers') }}" class="submenu-link {{ request()->routeIs('radiis.researchers') ? 'active' : '' }}">
                    <i class="bi bi-person-workspace"></i><span class="menu-label">Researchers</span>
                </a>
                <a href="{{ route('radiis.agencies') }}" class="submenu-link {{ request()->routeIs('radiis.agencies') ? 'active' : '' }}">
        ...
        <div class="sidebar-item">
            <div class="sidebar-parent {{ request()->routeIs('eis.*') ? 'active' : '' }}"
                ...
                <span class="sidebar-chevron" data-target="eisMenu" style="cursor:pointer;padding:0 16px 0 8px;">
                    <i class="bi bi-chevron-down"></i>
                </span>
            </div>
            <div class="sidebar-submenu {{ request()->routeIs('eis.*') ? 'open' : '' }}"
                ...
                <a href="{{ route('eis.fund') }}" class="submenu-link {{ request()->routeIs('eis.fund') ? 'active' : '' }}">
                    <i class="bi bi-wallet2"></i><span class="menu-label">Funds</span>
                </a>
                <a href="{{ route('eis.facility') }}" class="submenu-link {{ request()->routeIs('eis.facility') ? 'active' : '' }}">
                    <i class="bi bi-buildings"></i><span class="menu-label">Facilities</span>
                </a>
                <a href="{{ route('eis.bid') }}" class="submenu-link {{ request()->routeIs('eis.bid') ? 'active' : '' }}">
...
<style>
    ...
    .sidebar.collapsed .sidebar-parent .sidebar-link { padding: 12px 0; justify-content: center; width: 68px; }
    ...
    .sidebar.collapsed .sidebar-parent[data-label]:hover::after {
        ...
        transform: translateY(-50%); background: #0f8f3a; color: white;
    ...
    .sidebar-toggle-btn {
        ...
        color: white; font-size: 0.9rem; display: flex; align-items: center; justify-content: center;
        cursor: pointer; z-index: 1100; box-shadow: 0 2px 8px rgba(0,0,0,0.5);
            ...
            chevron.addEventListener('click', function () {
                ...
                document.querySelectorAll('.sidebar-submenu.open').forEach(function (el) {
                    if (el.id !== targetId) {
                        ...
                        const ch = document.querySelector(`.sidebar-chevron[data-target="${el.id}"]`);
